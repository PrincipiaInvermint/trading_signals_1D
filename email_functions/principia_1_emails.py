...
def principia_sender_1(df, type):
    ...
    # df_students = pd.read_excel('BD.xlsx', sheet_name='Sheet1', engine='openpyxl')
    ...
    server.sendmail(gmail_user, gmail_destination_1, msg.as_string())
    server.quit()
